...
def contarLetrasNombre(x):
    contarLetrasNombre=str
    contador=0
for i in contarLetrasNombre:
contador= contador +1
pass
print(contarLetrasNombre,contador)
...
def potenciacion(base, exponente):
    ...
    for i in range(1,exponente,1):
        ...
        print(str(base)+str(exponente)+str(resultado))
